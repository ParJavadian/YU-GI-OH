...
//
    ...
    public void startBattleNoCardSelected() throws Exception {
        ...
        setMouseEventsBattlePhase(imageView1hand1, player, 1, 20, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand2, player, 2, 21, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand3, player, 3, 22, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand4, player, 4, 23, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand5, player, 5, 24, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand6, player, 6, 25, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
