...
//
    ...
    public void startMainNoCardSelected() throws Exception {
        ...
        setMouseEventsMainPhase(imageView1Monster1, player, 5, 0, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("flipSummon"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("changePosition"));
        setMouseEventsMainPhase(imageView1Monster2, player, 3, 1, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("flipSummon"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("changePosition"));
        setMouseEventsMainPhase(imageView1Monster3, player, 1, 2, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("flipSummon"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("changePosition"));
        setMouseEventsMainPhase(imageView1Monster4, player, 2, 3, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("flipSummon"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("changePosition"));
        setMouseEventsMainPhase(imageView1Monster5, player, 4, 4, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("flipSummon"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("changePosition"));
        setMouseEventsMainPhase(imageView2Monster1, rival, 4, 5, DuelController.class.getMethod("selectCardOpponentMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView2Monster2, rival, 2, 6, DuelController.class.getMethod("selectCardOpponentMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView2Monster3, rival, 1, 7, DuelController.class.getMethod("selectCardOpponentMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView2Monster4, rival, 3, 8, DuelController.class.getMethod("selectCardOpponentMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView2Monster5, rival, 5, 9, DuelController.class.getMethod("selectCardOpponentMonsterZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView1SpellAndTrap1, player, 5, 10, DuelController.class.getMethod("selectCardPlayerTrapAndSpellZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("activateSpell"), DuelController.class.getMethod("doNothing", int.class));
        ...
        setMouseEventsMainPhase(imageView2SpellAndTrap1, rival, 4, 15, DuelController.class.getMethod("selectCardOpponentTrapAndSpellZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        ...
        setMouseEventsMainPhase(imageView1FieldZone, player, 1, 32, DuelController.class.getMethod("selectCardPlayerFieldZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView2FieldZone, rival, 1, 33, DuelController.class.getMethod("selectCardOpponentFieldZone", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView1Graveyard, player, 1, 34, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("showPlayerGraveyard", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsMainPhase(imageView2Graveyard, rival, 1, 35, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("startMainNoCardSelected"), DuelController.class.getMethod("showRivalGraveyard", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
    }


    public void startBattleNoCardSelected() throws Exception {
        setMouseEventsBattlePhase(imageView1hand1, player, 1, 20, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand2, player, 2, 21, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand3, player, 3, 22, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand4, player, 4, 23, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand5, player, 5, 24, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1hand6, player, 6, 25, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1Monster1, player, 5, 0, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1Monster2, player, 3, 1, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1Monster3, player, 1, 2, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1Monster4, player, 2, 3, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1Monster5, player, 4, 4, DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("selectCardPlayerMonsterZone", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2Monster1, rival, 4, 5, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("attackMonster", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2Monster2, rival, 2, 6, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("attackMonster", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2Monster3, rival, 1, 7, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("attackMonster", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2Monster4, rival, 3, 8, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("attackMonster", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2Monster5, rival, 5, 9, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("attackMonster", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1SpellAndTrap1, player, 5, 10, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1SpellAndTrap2, player, 3, 11, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1SpellAndTrap3, player, 1, 12, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1SpellAndTrap4, player, 2, 13, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1SpellAndTrap5, player, 4, 14, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2SpellAndTrap1, rival, 4, 15, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2SpellAndTrap2, rival, 2, 16, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2SpellAndTrap3, rival, 1, 17, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2SpellAndTrap4, rival, 3, 18, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2SpellAndTrap5, rival, 5, 19, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1FieldZone, player, 1, 32, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2FieldZone, rival, 1, 33, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView1Graveyard, player, 1, 34, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
        setMouseEventsBattlePhase(imageView2Graveyard, rival, 1, 35, DuelController.class.getMethod("doNothing", int.class), this.getClass().getMethod("doNothing"), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class), DuelController.class.getMethod("doNothing", int.class));
    }
    ...
    private void setMouseEventsBattlePhase(ImageView imageView, User owner, int number1, int numberForGet, Method onMouseEnteredMethod, Method nextMethod, Method onMouseClickedMethodMonster, Method onMouseClickedMethodSpell, Method onMouseRightClickedMethod) {
        imageView.setOnMouseEntered(event -> {
            if (imageView.getImage() == null) return;
            clearCardDetails();
            if (!imageView.getImage().equals(unknown) || owner.equals(player))
