...
public class User {
    ...
    public void setPassword(String password) {
        ...
        importExportUserController.exportNewUser(model.User.getUserByUsername(this.getUsername()));
    }

    public void setNickname(String nickname) {
        this.nickname = nickname;
        ImportExportUserController importExportUserController = ImportExportUserController.getInstance();
        importExportUserController.exportNewUser(model.User.getUserByNickname(nickname));
    }

    public void setUsername(String username) {
        this.username = username;
        ImportExportUserController importExportUserController = ImportExportUserController.getInstance();
        importExportUserController.exportNewUser(model.User.getUserByUsername(username));
        importExportUserController.exportAllUsers(model.User.getAllUsers());
    }
...
//    }
    ...
    public void addDeck(Deck deck) {
        ...
        ImportExportUserController importExportUserController = ImportExportUserController.getInstance();
        importExportUserController.exportAllDecksName(this.getAllDecks(), Objects.requireNonNull(model.User.getUserByUsername(username)));
    }
